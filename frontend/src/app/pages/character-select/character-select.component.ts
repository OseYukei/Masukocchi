  ...
  characters: { id: number; name: Character; img: string; description: string }[] = [
    {
      ...
      description:
        '喧嘩ですか…。わかりました。<br>わたくしがその喧嘩に判決を下しましょう。<br>喧嘩の原因やお二人の主張をしっかりと伺い、<br>勝訴か、敗訴かの判決を下します。お二人とも、<br>正しい心をもって裁判に挑んでください。<br><br><br>判決結果：<br>　両者の意見を聞き、<br>　「勝訴」か「敗訴」かの判決を下します。<br><br>向いてる場面：<br>　どちらが悪いか白黒つけたいとき<br>',
    },
    {
      id: 2,
      name: 'オネエ',
      ...
      description:
        'あらどうもいらっしゃい！<br>なに～、あなたたち喧嘩しちゃったの？<br>しょうがないわね…私が話聞いてあげるからあんたたち少し落ち着きなさい！どっちが悪いのか、それとも二人とも悪いのか、話を聞けばすぐわかるんだから！<br><br>判決結果：<br>　両者の意見を聞き、仲裁してくれます。<br><br><br>向いてる場面：<br>　お互いの主張を受け入れたいとき<br>　勝敗が決めにくいとき',
    },
    {
      id: 3,
      name: '全肯定マン',
    ...
    },
    {
      id: 0,
      name: '追加予定キャラクター',
      img: 'assets/character/coming-soon.png',
      description:
