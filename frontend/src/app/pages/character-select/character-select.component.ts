  ...
  characters: { id: number; name: Character; img: string; description: string }[] = [
    {
      ...
      description:
        '喧嘩ですか…。わかりました。わたくしがその喧嘩に判決を下しましょう。喧嘩の原因やお二人の主張をしっかりと伺い、勝訴か、敗訴かの判決を下します。お二人とも、正しい心をもって裁判に挑んでください。<br><br><br>判決結果：<br>　双方の意見を聞き、<br>　1人目が「勝訴」か「敗訴」かの判決を下します。<br><br>向いてる場面：<br>　どちらが悪いか白黒つけたいとき<br>',
    },
    {
      id: 2,
      name: 'オネエ',
      ...
      description:
        'あらどうもいらっしゃい！なに～、あなたたち喧嘩しちゃったの？しょうがないわね…私が話聞いてあげるからあんたたち少し落ち着きなさい！どっちが悪いのか、それとも二人とも悪いのか、話を聞けばすぐわかるんだから！<br><br><br>判決結果：<br>　<br><br><br>向いてる場面：<br>',
    },
    {
      id: 3,
      name: '全肯定マン',
      ...
      description:
        'やあ！こんにちは！世の中のすべてをポジティブに受け入れる、全肯定マンだ！みんなの意見も、感情も、何でも大歓迎！すべて肯定してみせる！さぁ、ポジティブエネルギー全開で受け取って、みんなでハッピーな時間を過ごそうぜ！<br><br><br>判決結果：<br>　<br><br><br>向いてる場面：<br>',
    },
    {
      id: 4,
      name: '全否定マン',
      ...
      description:
        'よく来たな、愚かなる者ども…俺は全否定マン。世の中のあらゆる意見を跳ね除け、暗黒の中で支配を狙う者だ。喧嘩をしたからどちらが悪いか判断してほしいだと？ふん、貴様らの喧嘩も、くだらん主張もどうでもいい。貴様らのその主張、この俺様がすべて否定してやる…。<br><br>判決結果：<br>　<br><br><br>向いてる場面：<br>',
    },
    {
      id: 5,
      name: '追加予定キャラクター',
